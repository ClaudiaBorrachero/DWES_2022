		...
		<div class="row justify-content-center mt-5">
			<div class="col-8">
				<form method="post">
    				...
    				<input value="${ sessionScope.productName }" type="text" class="form-control" id="productName" name="productName" required disabled>
    				<label for="productLine" class="form-label mt-3">Categoría</label>
    				<input type="text" class="form-control" id="productLine" name="productLine" required disabled>
