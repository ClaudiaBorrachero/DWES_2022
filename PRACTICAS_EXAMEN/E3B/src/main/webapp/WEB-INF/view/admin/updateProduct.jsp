		...
		<div class="row justify-content-center mt-5">
			<div class="col-8">
				<form method="post">
    				...
    				<input value="${ requestScope.product.productName }" type="text" class="form-control" id="productName" name="productName" required disabled>
    				...
    				<input value="${ product.quantityInStock }" type="text" class="form-control" id="quantityInStock" name="quantityInStock" required disabled>
