...
import org.alixar.servidor.cnbm.dao.DAOOficinaImpl;
...
public class OficinaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (oficinas!=null) {
			...
			DAOOficinaImpl daoOficinaImpl = new DAOOficinaImpl();
			
			sesion.setAttribute("oficinas", daoOficinaImpl.getOficina(oficinas));
